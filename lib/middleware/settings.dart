...
Future<void> _updateSubjectThemes(
  ...
  // Piggybacks on the existing handler for dashboard/calendar/grades "loaded"
  // rather than registering a second one: built_redux chains handlers for the
  // same action, so a second one would dispatch through to the reducer twice.
