...
class AbsenceGroupWidget extends StatelessWidget {
  ...
  /// Opens the justification dialog. Null when justifying is turned off.
  final VoidCallback? onJustify;

  const AbsenceGroupWidget({super.key, required this.vm, this.onJustify});
  @override
            ...
            if (onJustify != null)
              Align(
                ...
                child: TextButton.icon(
                  ...
                  label: Text(
                    vm.justified == AbsenceJustified.notYetJustified ||
                            vm.justified == AbsenceJustified.notJustified
                        ? "Entschuldigen"
                        : "Bearbeiten",
                  ),
...
class FutureAbsenceWidget extends StatelessWidget {
  ...
  /// Withdraws the announced absence. Null when that is turned off.
