...
import 'package:dr/school_year.dart' show calculateEaster;
...
// `calculateEaster` moved to school_year.dart, where the default holiday dates
// need it too; it is re-exported here so the existing callers are unchanged.
