...
class Sidebar extends StatelessWidget {
  const Sidebar({
    ...
    this.holidayCountdown,
    this.lastDayCountdown,
    this.showCountdownDate,
  });

  /// Shown above "Einstellungen" when they are switched on.
  final Countdown? holidayCountdown;
  final Countdown? lastDayCountdown;

  /// Opens the calendar at the countdown's date.
  final void Function(UtcDateTime date)? showCountdownDate;
  ...
  Widget build(BuildContext context) {
    return CollapsibleSidebar(
      ...
      items: [
        ...
        // here. Tapping one jumps to that week in the calendar.
        for (final countdown
            in [holidayCountdown, lastDayCountdown].whereType<Countdown>())
          CollapsibleItem(
            hasDivider: countdown == holidayCountdown ||
                holidayCountdown == null,
            text: "${countdown.label}: ${countdown.daysLabel}",
            icon: countdown.label == "Schulende"
                ? Icons.flag_outlined
                : Icons.beach_access_outlined,
            onPressed: () => showCountdownDate?.call(countdown.date),
          ),
        CollapsibleItem(
          hasDivider: true,
          text: "Einstellungen",
