...
abstract class SettingsActions extends ReduxActions {
  ...
  abstract final ActionDispatcher<bool> setNotificationsEnabled;
  abstract final ActionDispatcher<int> setNotificationInterval;
  abstract final ActionDispatcher<bool> setBackgroundServiceEnabled;
  abstract final ActionDispatcher<bool> setShowGradeTrends;
  abstract final ActionDispatcher<bool> setAbsenceWarningEnabled;
  abstract final ActionDispatcher<int> setAbsenceWarningThreshold;
  abstract final ActionDispatcher<bool> setPrefetchAttachments;
  abstract final ActionDispatcher<bool> setAbsenceEntryEnabled;
  abstract final ActionDispatcher<bool> setMessageComposeEnabled;
  ...
  /// Subject to target grade, scaled by 100. A value of 0 removes the target.
  abstract final ActionDispatcher<MapEntry<String, int>> setGradeTarget;

  abstract final ActionDispatcher<BuiltList<HolidayPeriod>> setHolidays;
  abstract final ActionDispatcher<UtcDateTime?> setLastSchoolDay;
  abstract final ActionDispatcher<bool> setShowSchoolYearCountdown;
  abstract final ActionDispatcher<int> setWeeklyLessons;
